...
annotations_file = '/home/zzhu/neural_rendering/data/chenxin/chenxin-annotation-train.csv'  # pose annotation path
save_path = '/home/zzhu/neural_rendering/data/chenxin/trainK'  # path to store pose maps
...
def compute_pose(annotations_file, savePath, image_size):
...
if not os.path.isdir(save_path):
    os.mkdir(save_path)
compute_pose(annotations_file, save_path, image_size)
